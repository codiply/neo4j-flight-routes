...
def main():
    ...
    airline_ids = cutdown('data/airlines.dat', 'data/airlines_cutdown.dat', airline_fieldnames, airline_pred, 'id')
    ...
    airport_ids = cutdown('data/airports.dat', 'data/airports_cutdown.dat', airport_fieldnames, airport_pred, 'id')  
